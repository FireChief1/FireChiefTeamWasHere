...
class QAAgent(BaseAgent[QAOutput]):
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "Cover the happy path, edge cases (empty, zero, boundary values), "
            "and error cases (invalid input that should raise). Use the "
            ...
            "verify it before writing it -- a wrong expected value makes a "
            "correct implementation fail. If you are unsure of an expected "
            "value, choose a simpler test case where you are certain. Name "
            "each test accurately for what it actually checks.\n\n"
